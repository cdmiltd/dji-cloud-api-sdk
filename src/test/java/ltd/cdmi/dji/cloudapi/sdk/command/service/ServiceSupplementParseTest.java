...
/**
 * 验证 {@link MessageCodec#parse(String, Class)} 对补全的 17 个 services 指令 POJO 的类型安全解析。
 *
...
class ServiceSupplementParseTest {
    ...
    void testParseOtaCreateRequest() {
        ...
        DjiMessage<OtaCreateRequest> msg = MessageCodec.parse(payload, OtaCreateRequest.class);
    ...
    void testParseFileUploadStartRequest() {
        ...
        DjiMessage<FileUploadStartRequest> msg = MessageCodec.parse(payload, FileUploadStartRequest.class);
    ...
    void testParseFileUploadUpdateRequest() {
        ...
        DjiMessage<FileUploadUpdateRequest> msg = MessageCodec.parse(payload, FileUploadUpdateRequest.class);
    ...
    void testParseFileUploadListReply() {
        ...
        DjiMessage<FileUploadListReply> msg = MessageCodec.parse(replyPayload, FileUploadListReply.class);
    ...
    void testParseInFlightWaylineDeliverRequest() {
        ...
        DjiMessage<InFlightWaylineDeliverRequest> msg = MessageCodec.parse(payload, InFlightWaylineDeliverRequest.class);
    ...
    void testParseInFlightWaylineStopRequest() {
        ...
        DjiMessage<InFlightWaylineStopRequest> msg = MessageCodec.parse(payload, InFlightWaylineStopRequest.class);
    ...
    void testParseInFlightWaylineRecoverRequest() {
        ...
        DjiMessage<InFlightWaylineRecoverRequest> msg = MessageCodec.parse(payload, InFlightWaylineRecoverRequest.class);
    ...
    void testParseSpeakerPlayVolumeSetRequest() {
        ...
        DjiMessage<SpeakerPlayVolumeSetRequest> msg = MessageCodec.parse(payload, SpeakerPlayVolumeSetRequest.class);
    ...
    void testParseSpeakerPlayModeSetRequest() {
        ...
        DjiMessage<SpeakerPlayModeSetRequest> msg = MessageCodec.parse(payload, SpeakerPlayModeSetRequest.class);
    ...
    void testParseSpeakerPlayStopRequest() {
        ...
        DjiMessage<SpeakerPlayStopRequest> msg = MessageCodec.parse(payload, SpeakerPlayStopRequest.class);
    ...
    void testParseSpeakerReplayRequest() {
        ...
        DjiMessage<SpeakerReplayRequest> msg = MessageCodec.parse(payload, SpeakerReplayRequest.class);
    ...
    void testParseSpeakerTtsPlayStartRequest() {
        ...
        DjiMessage<SpeakerTtsPlayStartRequest> msg = MessageCodec.parse(payload, SpeakerTtsPlayStartRequest.class);
    ...
    void testParseSpeakerAudioPlayStartRequest() {
        ...
        DjiMessage<SpeakerAudioPlayStartRequest> msg = MessageCodec.parse(payload, SpeakerAudioPlayStartRequest.class);
    ...
    void testParsePsdkInputBoxTextSetRequest() {
        ...
        DjiMessage<PsdkInputBoxTextSetRequest> msg = MessageCodec.parse(payload, PsdkInputBoxTextSetRequest.class);
    ...
    void testParsePsdkWidgetValueSetRequest() {
        ...
        DjiMessage<PsdkWidgetValueSetRequest> msg = MessageCodec.parse(payload, PsdkWidgetValueSetRequest.class);
    ...
    void testParseCustomDataTransmissionToPsdkRequest() {
        ...
        DjiMessage<CustomDataTransmissionToPsdkRequest> msg = MessageCodec.parse(payload, CustomDataTransmissionToPsdkRequest.class);
    ...
    void testParseCustomDataTransmissionToEsdkRequest() {
        ...
        DjiMessage<CustomDataTransmissionToEsdkRequest> msg = MessageCodec.parse(payload, CustomDataTransmissionToEsdkRequest.class);
