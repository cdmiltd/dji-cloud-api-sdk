...
/**
 * 验证 {@link DrcSpeakerReplayRequest} 的 Jackson 反序列化、序列化与往返闭环。
 *
 * <p><b>核心证明</b>：
 * <ol>
 *   <li>DRC {@code drc_speaker_replay} 指令 data JSON（仅含 psdk_index）
 ...
 * </ol>
 */
class DrcSpeakerReplayRequestTest {
    ...
    void testDeserialize() {
        ...
        DrcSpeakerReplayRequest req = MessageCodec.fromJson(json, DrcSpeakerReplayRequest.class);
    ...
    void testSerialize() {
        DrcSpeakerReplayRequest req = new DrcSpeakerReplayRequest(PSDK_INDEX);
    ...
    void testRoundTrip() {
        DrcSpeakerReplayRequest original = new DrcSpeakerReplayRequest(PSDK_INDEX);
        String json = MessageCodec.toJson(original);
        DrcSpeakerReplayRequest back = MessageCodec.fromJson(json, DrcSpeakerReplayRequest.class);
    ...
    void testMissingPsdkIndexThrowsNpe() {
        assertThrows(IllegalStateException.class,
                () -> MessageCodec.fromJson("{}", DrcSpeakerReplayRequest.class));
    }
}
