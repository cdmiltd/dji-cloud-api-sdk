...
/**
 * airport_organization_get 指令请求 data。
 *
 * <p>对应 DJI Cloud API {@code airport_organization_get} 指令（requests 通道）的请求 data。
 * 用于根据绑定码与组织 ID 查询机场归属组织信息。
 *
 * <p>字段依据：simulator {@code DockOnlineService} L212-L215 已对接 hivemind 验证。
 */
@DocUrl("https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt-dock.html")
@Verified(basis = "simulator DockOnlineService L212-L215 已对接 hivemind 验证")
public record AirportOrganizationGetRequest(
