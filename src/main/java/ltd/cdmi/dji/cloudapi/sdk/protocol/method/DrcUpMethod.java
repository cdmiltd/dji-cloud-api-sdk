 ...
 *
 * <p>本枚举覆盖 11 个 drc/up 推送 method（全部 @Verified）：
 * <ul>
...
@Verified(basis = "simulator 已对接 hivemind 验证 10 个 drc/up 推送 method；drc_camera_photo_info_push 按 DJI Dock2/Dock3 remote-control 文档 Data 表验证")
