...
/**
 * WPML {@code actionActuatorFuncParam}（gimbalEvenlyRotate）参数。
 *
 * <p>云台均匀旋转动作参数，定义云台 Pitch 转动角度与负载位置。
 * 该动作仅在航段间均匀转动云台 pitch 角，其触发器类型必须为
 * {@code betweenAdjacentPoints}。
 *
 * <p>字段顺序依照 DJI WPML 共用元素文档 gimbalEvenlyRotate 定义。
 *
...
@Verified(basis = "DJI WPML 共用元素文档 gimbalEvenlyRotate actionActuatorFuncParam 参数定义")
@JacksonXmlRootElement(localName = "actionActuatorFuncParam", namespace = WpmlNamespaces.WPML)
public record GimbalEvenlyRotateParam(
