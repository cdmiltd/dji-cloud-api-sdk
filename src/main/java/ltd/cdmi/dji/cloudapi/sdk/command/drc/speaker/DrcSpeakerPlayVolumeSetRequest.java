...
/**
 * drc_speaker_play_volume_set 指令请求 data。
 *
 * <p>喊话器播放音量设置。
 *
 ...
 *   <li>{@code playVolume} — 播放音量（1-100）</li>
 * </ul>
 *
 * @see ltd.cdmi.dji.cloudapi.sdk.protocol.method.DrcMethod#DRC_SPEAKER_PLAY_VOLUME_SET
 */
...
public record DrcSpeakerPlayVolumeSetRequest(
    Integer psdkIndex,
    Integer playVolume
) {
    public DrcSpeakerPlayVolumeSetRequest {
        Objects.requireNonNull(psdkIndex, "psdkIndex 必填，DJI JSON 缺失 psdk_index 字段");
        Objects.requireNonNull(playVolume, "playVolume 必填，DJI JSON 缺失 play_volume 字段");
    }
}
