...
public record LiveCameraChangeRequest(
    String videoId,
    Integer cameraPosition
) {
    public LiveCameraChangeRequest {
        Objects.requireNonNull(videoId, "videoId 必填，DJI JSON 缺失 video_id 字段");
        Objects.requireNonNull(cameraPosition, "cameraPosition 必填，DJI JSON 缺失 camera_position 字段");
    }
}
