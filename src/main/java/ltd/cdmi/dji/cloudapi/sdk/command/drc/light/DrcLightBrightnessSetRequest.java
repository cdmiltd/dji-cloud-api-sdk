...
/**
 * drc_light_brightness_set 指令请求 data。
 *
 * <p>探照灯亮度设置。
 *
 ...
 *   <li>{@code brightness} — 亮度值</li>
 * </ul>
 *
 * @see ltd.cdmi.dji.cloudapi.sdk.protocol.method.DrcMethod#DRC_LIGHT_BRIGHTNESS_SET
 */
...
public record DrcLightBrightnessSetRequest(
    Integer psdkIndex,
    Integer brightness
) {
    public DrcLightBrightnessSetRequest {
        Objects.requireNonNull(psdkIndex, "psdkIndex 必填，DJI JSON 缺失 psdk_index 字段");
        Objects.requireNonNull(brightness, "brightness 必填，DJI JSON 缺失 brightness 字段");
    }
}
