...
/**
 * 验证 {@link DjiMessage#parse(String, Class)} 对补全的 8 个 services 带参 POJO 的类型安全解析。
 *
...
class ServiceParamParseTest {
    ...
    @Test
    @DisplayName("esim_activate — imei + device_type（@Verified DJI Dock3 cmd 文档确认）")
    void testParseEsimActivate() {
        String payload = "{\"method\":\"esim_activate\","
                + "\"data\":{\"imei\":\"8986041234567890123\",\"device_type\":\"dock\"},"
                + "\"tid\":\"t1\",\"bid\":\"b1\"}";
        DjiMessage<EsimActivateRequest> msg =
                DjiMessage.parse(payload, EsimActivateRequest.class);
        assertEquals("8986041234567890123", msg.data().imei());
    ...
    void testParseEsimOperatorSwitch() {
        ...
        DjiMessage<EsimOperatorSwitchRequest> msg =
                DjiMessage.parse(payload, EsimOperatorSwitchRequest.class);
    ...
    @Test
    @DisplayName("sim_slot_switch — imei/device_type/sim_slot（@Verified DJI Dock3 cmd 文档确认）")
    void testParseSimSlotSwitch() {
        String payload = "{\"method\":\"sim_slot_switch\","
                + "\"data\":{\"imei\":\"imei-001\",\"device_type\":\"dock\",\"sim_slot\":1},"
                + "\"tid\":\"t1\",\"bid\":\"b1\"}";
        DjiMessage<SimSlotSwitchRequest> msg =
                DjiMessage.parse(payload, SimSlotSwitchRequest.class);
        assertEquals("imei-001", msg.data().imei());
        assertEquals("dock", msg.data().deviceType());
        assertEquals(1, msg.data().simSlot());
    }
    ...
    void testParseRtkCalibration() {
        ...
        DjiMessage<RtkCalibrationRequest> msg =
                DjiMessage.parse(payload, RtkCalibrationRequest.class);
    ...
    void testParseBatteryStoreModeSwitch() {
        ...
        DjiMessage<BatteryStoreModeSwitchRequest> msg =
                DjiMessage.parse(payload, BatteryStoreModeSwitchRequest.class);
    ...
    void testParseAlarmStateSwitch() {
        ...
        DjiMessage<AlarmStateSwitchRequest> msg =
                DjiMessage.parse(payload, AlarmStateSwitchRequest.class);
    ...
    void testParseAirConditionerModeSwitch() {
        ...
        DjiMessage<AirConditionerModeSwitchRequest> msg =
                DjiMessage.parse(payload, AirConditionerModeSwitchRequest.class);
    ...
    void testParseSdrWorkmodeSwitch() {
        ...
        DjiMessage<SdrWorkmodeSwitchRequest> msg =
                DjiMessage.parse(payload, SdrWorkmodeSwitchRequest.class);
