...
/**
 * 验证 {@link HeartBeatReply} 的 Jackson 反序列化、序列化与往返闭环。
 *
 * <p><b>核心证明</b>：
 * <ol>
 *   <li>DRC {@code heart_beat} 回复 data JSON（含 timestamp）
 *       能反序列化为 record</li>
...
class HeartBeatReplyTest {
    ...
    void testDeserialize() {
        ...
        HeartBeatReply reply = MessageCodec.fromJson(json, HeartBeatReply.class);
    ...
    void testSerialize() {
        HeartBeatReply reply = new HeartBeatReply(TIMESTAMP);
    ...
    void testRoundTrip() {
        HeartBeatReply original = new HeartBeatReply(TIMESTAMP);
        String json = MessageCodec.toJson(original);
        HeartBeatReply back = MessageCodec.fromJson(json, HeartBeatReply.class);
    ...
    void testMissingTimestampThrowsNpe() {
        assertThrows(IllegalStateException.class,
                () -> MessageCodec.fromJson("{}", HeartBeatReply.class));
    }
}
