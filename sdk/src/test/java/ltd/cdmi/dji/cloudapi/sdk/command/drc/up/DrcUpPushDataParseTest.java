...
/**
 * 验证 {@link DjiMessage#parse(String, Class)} 对 DRC 上行推送消息的类型安全解析。
 *
 * <p><b>核心证明</b>：DRC 上行消息信封为 {@code {method, data, seq}}（无 tid/bid），
 * {@link DjiMessage#parse} 仍能解析出 {@link DjiMessage}<T>，{@code data()} 是调用方指定的 POJO 类型。
 *
...
class DrcUpPushDataParseTest {
    ...
    void testParseOsdInfoPushData() {
        ...
        DjiMessage<OsdInfoPushData> msg = DjiMessage.parse(payload, OsdInfoPushData.class);
    ...
    void testParseHsiInfoPushData() {
        ...
        DjiMessage<HsiInfoPushData> msg = DjiMessage.parse(payload, HsiInfoPushData.class);
    ...
    void testParseDelayInfoPushData() {
        ...
        DjiMessage<DelayInfoPushData> msg = DjiMessage.parse(payload, DelayInfoPushData.class);
    ...
    void testParseDroneStatePushData() {
        ...
        DjiMessage<DroneStatePushData> msg = DjiMessage.parse(payload, DroneStatePushData.class);
    ...
    void testParsePsdkFloatingWindowTextData() {
        ...
        DjiMessage<PsdkFloatingWindowTextData> msg = DjiMessage.parse(payload, PsdkFloatingWindowTextData.class);
    ...
    void testParsePsdkUiResourceData() {
        ...
        DjiMessage<PsdkUiResourceData> msg = DjiMessage.parse(payload, PsdkUiResourceData.class);
    ...
    void testParseSpeakerPlayProgressData() {
        ...
        DjiMessage<SpeakerPlayProgressData> msg = DjiMessage.parse(payload, SpeakerPlayProgressData.class);
    ...
    void testParseCameraStatePushData() {
        ...
        DjiMessage<CameraStatePushData> msg = DjiMessage.parse(payload, CameraStatePushData.class);
        ...
        assertEquals(16, data.cameraState().photoFormat());
    ...
    @Test
    @DisplayName("drc_camera_state_push — photo_format 缺省时反序列化为 null（旧固件兼容）")
    void testParseCameraStatePushData_withoutPhotoFormat() {
        String payload = "{\"method\":\"drc_camera_state_push\","
                + "\"data\":{\"payload_index\":\"165-0-7\","
                + "\"camera_state\":{\"camera_mode\":0,\"interval_photo_interval\":5,"
                + "\"video_resolution\":\"1920x1080\",\"linkage_zoom_state\":0,"
                + "\"photo_size\":\"4:3\",\"record_time\":0,\"recording_state\":0,"
                + "\"photo_state\":0,\"remain_photo_num\":100,\"remain_record_duration\":3600,"
                + "\"night_mode_settings\":{\"night_mode\":0,\"denoise_level\":0,"
                + "\"night_vision_enable\":false,\"infrared_fill_light_enable\":false,"
                + "\"night_scene_mode_suggestion\":0,\"is_working\":0}},"
                + "\"media_storage\":{\"photo_storage_settings\":[\"current\"],"
        ...
        CameraStatePushData data = msg.data();
        assertNull(data.cameraState().photoFormat());
    }
    ...
    void testParseCameraOsdInfoPushData() {
        ...
        DjiMessage<CameraOsdInfoPushData> msg = DjiMessage.parse(payload, CameraOsdInfoPushData.class);
    ...
    void testParsePsdkStateInfoDataLight() {
        ...
        DjiMessage<PsdkStateInfoData> msg = DjiMessage.parse(payload, PsdkStateInfoData.class);
    ...
    void testParseCameraPhotoInfoPushData() {
        ...
        DjiMessage<CameraPhotoInfoPushData> msg = DjiMessage.parse(payload, CameraPhotoInfoPushData.class);
