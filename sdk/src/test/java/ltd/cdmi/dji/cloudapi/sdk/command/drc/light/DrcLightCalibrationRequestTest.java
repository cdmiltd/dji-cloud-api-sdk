...
/**
 * 验证 {@link DrcLightCalibrationRequest} 的 Jackson 反序列化、序列化与往返闭环。
 *
 * <p><b>核心证明</b>：
 * <ol>
 *   <li>DRC {@code drc_light_calibration} 指令 data JSON（仅含 psdk_index）
 ...
 * </ol>
 */
class DrcLightCalibrationRequestTest {
    ...
    void testDeserialize() {
        ...
        DrcLightCalibrationRequest req = MessageCodec.fromJson(json, DrcLightCalibrationRequest.class);
    ...
    void testSerialize() {
        DrcLightCalibrationRequest req = new DrcLightCalibrationRequest(PSDK_INDEX);
    ...
    void testRoundTrip() {
        DrcLightCalibrationRequest original = new DrcLightCalibrationRequest(PSDK_INDEX);
        String json = MessageCodec.toJson(original);
        DrcLightCalibrationRequest back = MessageCodec.fromJson(json, DrcLightCalibrationRequest.class);
    ...
    void testMissingPsdkIndexThrowsNpe() {
        assertThrows(IllegalStateException.class,
                () -> MessageCodec.fromJson("{}", DrcLightCalibrationRequest.class));
    }
}
