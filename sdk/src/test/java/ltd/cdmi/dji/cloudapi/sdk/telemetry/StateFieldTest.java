 ...
 * <p><b>核心证明</b>：
 * <ol>
 *   <li>DJI Dock/飞行器 state 文档定义的 35 个 State 字段名（snake_case，pushMode=1）
...
class StateFieldTest {
    ...
    void testFromFieldNameAircraftControlSpotCheck() {
        ...
        assertEquals(StateField.REMAINING_POWER_FOR_RETURN_HOME, StateField.fromFieldName("remaining_power_for_return_home"));
    }
    ...
    @Test
    @DisplayName("fieldName() 与 fromFieldName() 形成双射：所有 35 个枚举值往返闭环")
