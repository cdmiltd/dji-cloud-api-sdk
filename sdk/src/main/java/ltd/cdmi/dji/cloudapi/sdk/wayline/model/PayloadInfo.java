...
/**
 * WPML {@code <wpml:payloadInfo>} 元素。
 *
 * <p>标识航线模板挂载负载，{@code payloadEnumValue} 为负载类型枚举值，
 * {@code payloadPositionIndex} 为负载挂载位置索引。
 *
 * @see DroneInfo
 */
@DocUrl("https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dji-wpml/template-kml.html")
@Verified(basis = "DJI WPML template.kml 文档 payloadInfo 元素定义")
public record PayloadInfo(
    @JacksonXmlProperty(localName = "payloadEnumValue", namespace = WpmlNamespaces.WPML)
