...
/**
 * return_specific_home 指令请求 data。
 *
 * <p>返回指定机场。
 *
...
public record ReturnSpecificHomeRequest(
    String homeDockSn
) {
    public ReturnSpecificHomeRequest {
        Objects.requireNonNull(homeDockSn, "homeDockSn 必填，DJI JSON 缺失 home_dock_sn 字段");
    }
}
