...
public record PhotoStorageSetRequest(
    String payloadIndex,
    ...
    public PhotoStorageSetRequest {
        ...
        Objects.requireNonNull(photoStorageSettings, "photoStorageSettings 必填，DJI JSON 缺失 photo_storage_settings 字段");
    }
}
