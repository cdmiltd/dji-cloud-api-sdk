...
/**
 * drc_camera_denoise_level_set 指令请求 data。
 *
 * <p>相机降噪等级设置。增强降噪会影响帧率。
 *
 ...
 *   <li>{@code level} — 降噪等级：0=关闭, 1=标准降噪, 2=增强降噪(15fps), 3=超强降噪(5fps)</li>
 * </ul>
 *
 * @see ltd.cdmi.dji.cloudapi.sdk.protocol.method.DrcMethod#DRC_CAMERA_DENOISE_LEVEL_SET
 */
