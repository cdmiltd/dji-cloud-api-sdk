...
/**
 * WPML {@code actionActuatorFuncParam}（startRecord）参数。
 *
 * <p>开始录像动作参数，定义负载位置、文件后缀、镜头索引以及是否使用全局镜头索引。
 *
...
@Verified(basis = "DJI WPML 共用元素文档 startRecord actionActuatorFuncParam 参数定义")
@JacksonXmlRootElement(localName = "actionActuatorFuncParam", namespace = WpmlNamespaces.WPML)
public record StartRecordParam(
