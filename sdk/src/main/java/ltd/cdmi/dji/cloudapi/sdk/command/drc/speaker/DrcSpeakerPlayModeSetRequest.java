...
/**
 * drc_speaker_play_mode_set 指令请求 data。
 *
 * <p>喊话器播放模式设置。
 *
 ...
 *   <li>{@code playMode} — 播放模式：0=单次播放, 1=循环播放</li>
 * </ul>
 *
 * @see ltd.cdmi.dji.cloudapi.sdk.protocol.method.DrcMethod#DRC_SPEAKER_PLAY_MODE_SET
 */
...
public record DrcSpeakerPlayModeSetRequest(
    Integer psdkIndex,
    Integer playMode
) {
    public DrcSpeakerPlayModeSetRequest {
        Objects.requireNonNull(psdkIndex, "psdkIndex 必填，DJI JSON 缺失 psdk_index 字段");
        Objects.requireNonNull(playMode, "playMode 必填，DJI JSON 缺失 play_mode 字段");
    }
}
