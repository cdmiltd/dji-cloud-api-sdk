...
/**
 * flighttask_prepare 指令请求的可执行条件。
 *
 * <p>对应 DJI Cloud API {@code flighttask_prepare} 请求 data 中 {@code executable_conditions} 字段。
 *
 * @see FlighttaskPrepareRequest#executableConditions()
 */
...
public record ExecutableConditions(
