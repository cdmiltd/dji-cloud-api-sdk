...
/**
 * drc_camera_night_vision_enable 指令请求 data。
 *
 * <p>相机黑白夜视使能。仅变焦 7x 以上生效。
 *
 ...
 *   <li>{@code enable} — 黑白夜视使能：true=开启, false=关闭</li>
 * </ul>
 *
 * @see ltd.cdmi.dji.cloudapi.sdk.protocol.method.DrcMethod#DRC_CAMERA_NIGHT_VISION_ENABLE
 */
...
public record DrcCameraNightVisionEnableRequest(
    String payloadIndex,
    Boolean enable
) {
