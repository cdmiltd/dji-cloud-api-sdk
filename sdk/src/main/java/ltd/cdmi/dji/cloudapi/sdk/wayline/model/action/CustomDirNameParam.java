...
/**
 * WPML {@code actionActuatorFuncParam}（customDirName）参数。
 *
 * <p>自定义媒体目录名动作参数，定义负载位置与目录名。
 *
