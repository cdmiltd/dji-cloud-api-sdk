...
/**
 * WPML {@code actionActuatorFuncParam}（takePhoto）参数。
 *
 * <p>拍照动作参数，定义负载位置、文件后缀、镜头索引以及是否使用全局镜头索引。
 *
