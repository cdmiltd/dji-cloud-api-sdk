...
public record VideoStorageSetRequest(
    String payloadIndex,
    ...
    public VideoStorageSetRequest {
        ...
        Objects.requireNonNull(videoStorageSettings, "videoStorageSettings 必填，DJI JSON 缺失 video_storage_settings 字段");
    }
}
