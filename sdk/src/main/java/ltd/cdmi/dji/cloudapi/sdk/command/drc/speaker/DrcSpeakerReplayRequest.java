...
/**
 * drc_speaker_replay 指令请求 data。
 *
 * <p>喊话器重新播放。除 {@code psdk_index} 外无其他业务字段。
 *
 ...
 * </ul>
 *
 * @see ltd.cdmi.dji.cloudapi.sdk.protocol.method.DrcMethod#DRC_SPEAKER_REPLAY
 */
...
public record DrcSpeakerReplayRequest(
    Integer psdkIndex
) {
    public DrcSpeakerReplayRequest {
