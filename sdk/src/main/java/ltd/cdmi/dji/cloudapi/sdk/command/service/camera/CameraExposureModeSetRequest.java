...
/**
 * camera_exposure_mode_set 指令请求 data。
 *
 * <p>设置相机曝光模式。
 *
...
public record CameraExposureModeSetRequest(
    String payloadIndex,
    String cameraType,
    ...
    public CameraExposureModeSetRequest {
        ...
        Objects.requireNonNull(exposureMode, "exposureMode 必填，DJI JSON 缺失 exposure_mode 字段");
    }
}
